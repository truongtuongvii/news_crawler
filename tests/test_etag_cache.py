...
from finhouse_rss.utils.etag_cache import ETagCache
from finhouse_rss.utils.vnexpress_feeds import VNEXPRESS_FEEDS, ALL_FINANCIAL_FEEDS, DEFAULT_FEED
...
def make_cache(initial_state: dict = None, state_key: str = "etag_cache") -> ETagCache:
    ...
    with patch.dict("sys.modules", {"wmill": mock_wmill}):
        import importlib
        import finhouse_rss.utils.etag_cache as module
